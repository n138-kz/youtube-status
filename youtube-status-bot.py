...
statistics_activate={}
statistics_activate['default']=[
    ['v_commentCount', True],
    ['v_likeCount', True],
    ['v_viewCount', True],
    ['c_subscriberCount', True],
    ['c_videoCount', True],
    ['c_viewCount', True],
]
for list in statistics_activate['default']:
    statistics_activate[list[0]]=os.environ.get('statistics_activate_'+list[0], list[1])
